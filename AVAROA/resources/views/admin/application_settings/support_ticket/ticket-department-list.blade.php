                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action__buttons">
                                                    ...
                                                    data-id="{{ $department->uuid }}" data-toggle="tooltip" title="{{ trans('remove') }}">
                                                    <i class="fa fa-remove"></i>
                                                 </a>

                                                 <form action="{{ route('settings.support-ticket.department.delete', $department->uuid) }}" method="post" id="delete-form-{{ $department->uuid }}" style="display: none;">
                                                     @csrf
                                                     @method('DELETE')
                                                 </form>
